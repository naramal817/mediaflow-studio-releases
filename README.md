...
## 자동 업데이트 채널 — 최신 2.18.3 (2026-09-11)

`latest.json` 이 **2.18.3** 을 가리킵니다(2.18.2 → 2.18.3 패치, 6개 파일, 원본 sha256 `71896dd2d5019fcdcfc9335fd4abd91a8e58623012889803f92309d3e0700cd3`).
